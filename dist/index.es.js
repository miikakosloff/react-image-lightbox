...
var ReactImageLightbox = /*#__PURE__*/ (function(_Component) {
  ...
  function ReactImageLightbox(props) {
    ...
    _this.handleRotateCCWButtonClick = _this.handleRotateCCWButtonClick.bind(
      _assertThisInitialized(_this)
    );
    _this.handleRotateCWButtonClick = _this.handleRotateCWButtonClick.bind(
      _assertThisInitialized(_this)
    );
...
ReactImageLightbox.propTypes = {
  ...
  rotateCWLabel: PropTypes.string,
  rotateCCWLabel: PropTypes.string,
...
ReactImageLightbox.defaultProps = {
  ...
  rotateCWLabel: 'Rotate image clockwise',
  rotateCCWLabel: 'Rotate image counterclockwise',
  prevSrc: null,
  prevRotation: 0,
