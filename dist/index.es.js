...
var ReactImageLightbox = /*#__PURE__*/function (_Component) {
  ...
  function ReactImageLightbox(props) {
    ...
    _this.handleRotateCCWButtonClick = _this.handleRotateCCWButtonClick.bind(_assertThisInitialized(_this));
    _this.handleRotateCWButtonClick = _this.handleRotateCWButtonClick.bind(_assertThisInitialized(_this));
    ...
    _this.requestRotateCCW = _this.requestRotateCCW.bind(_assertThisInitialized(_this));
    _this.requestRotateCW = _this.requestRotateCW.bind(_assertThisInitialized(_this));
    return _this;
  ...
  _createClass(ReactImageLightbox, [{
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          mainRotation = _this$props.mainRotation;
      ...
      var addImage = function addImage(srcType, imageClass, transforms) {
        ...
        imageStyle.transform = "rotate(".concat(90 * mainRotation, "deg)");
